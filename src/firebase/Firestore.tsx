...
function StreamConnection () {
    ...
    async function getUser (id:any) {
        const userRef = doc(db, userCol.toString(), id).withConverter(userConverter);
    ...
    async function getEventOrg (id:any) {
        const eventOrgRef = doc(db, eventOrgCol.toString(), id).withConverter(eventOrgConverter);
    ...
    async function getRank (id:any) {
        const rankRef = doc(db, ranksCol.toString(), id).withConverter(rankConverter);
    ...
    async function getEvent (id:any) {
        const eventRef = doc(db, eventsCol.toString(), id).withConverter(eventConverter);
